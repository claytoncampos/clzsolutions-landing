          ...
          <div className="space-y-10">
            ...
            <div className="pt-8 border-t border-white/20">
              ...
              <div className="flex gap-4">
                ...
                <a href="mailto:clzsolution@uol.com" className="w-14 h-14 bg-white/20 rounded-2xl flex items-center justify-center hover:bg-white/30 transition-all duration-300 backdrop-blur-sm">
