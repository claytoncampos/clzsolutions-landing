          ...
          <div className="space-y-10">
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-white/90 text-lg">Rua das Soluções, 123</p>
                  <p className="text-white/90 text-lg">São Paulo - SP, 01234-567</p>
                </div>
              </div>
            ...
            <div className="pt-8 border-t border-white/20">
              ...
              <div className="flex gap-4">
                ...
                <a href="mailto:clayton.almeida.campos@gmail.com" className="w-14 h-14 bg-white/20 rounded-2xl flex items-center justify-center hover:bg-white/30 transition-all duration-300 backdrop-blur-sm">
